...
public class IpPair {
  ...
  protected IpPair(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  protected static long getCPtr(IpPair obj) {
...
protected void finalize() {
  ...
  public IpPair(Ipoint first, Ipoint second) {
    this(surfjnimoduleJNI.new_IpPair__SWIG_1(Ipoint.getCPtr(first), first, Ipoint.getCPtr(second), second), true);
  }
  ...
  public void setFirst(Ipoint value) {
    surfjnimoduleJNI.IpPair_first_set(swigCPtr, this, Ipoint.getCPtr(value), value);
  }
  ...
  public void setSecond(Ipoint value) {
    surfjnimoduleJNI.IpPair_second_set(swigCPtr, this, Ipoint.getCPtr(value), value);
  }
