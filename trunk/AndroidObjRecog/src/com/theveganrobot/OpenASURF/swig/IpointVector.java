...
public class IpointVector {
  ...
  protected IpointVector(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  protected static long getCPtr(IpointVector obj) {
...
protected void finalize() {
  ...
  public Ipoint get(int i) {
    return new Ipoint(surfjnimoduleJNI.IpointVector_get(swigCPtr, this, i), false);
  }

  public void set(int i, Ipoint val) {
    surfjnimoduleJNI.IpointVector_set(swigCPtr, this, i, Ipoint.getCPtr(val), val);
  }
